...
MW_Handle_Type MW_ETH_ThingSpeak_Open(uint8_T blockIndex, uint32_T ServerPort,char_T *RemoteIPAddress);
...
MW_ETH_Status_Type MW_ETH_ThingSpeakReceive(MW_Handle_Type ETHHandle,  void *data , uint8_T readWrite);
