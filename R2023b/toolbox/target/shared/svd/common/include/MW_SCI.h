...
/*Return the number of bytes available in receive buffer */
int32_T MW_SCI_GetNumberOfBytesAvailable(MW_Handle_Type SCIModuleHandle);

/*Flush the recive buffer*/
void MW_SCI_Flush(MW_Handle_Type SCIModuleHandle);
